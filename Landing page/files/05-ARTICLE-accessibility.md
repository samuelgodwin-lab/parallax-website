...
The angle: India is in the middle of the change the other three markets
have already been through. The Supreme Court struck the "recommendatory"
accessibility rules in November 2024; the draft RPwD (Amendment) Rules
2026 (July) make IS 17802 the mandatory floor for every establishment
offering digital products to people in India, phased by turnover; and for
government the operational standard, GIGW 3.0, already applies with 88
mandatory checkpoints and an STQC audit. For the Northeast — eight states
digitising citizen services fast, in eight-plus languages — that is the
whole procurement conversation for the next two years.

---

**Slug:** `/articles/accessibility-northeast-india`
**Title (CMS, accent marked):** Accessibility in Northeast India: the guidelines just became the *law*
**Title tag (58):** India's Accessibility Rules 2026: GIGW 3.0, IS 17802, Deadlines
**Description (154):** India's accessibility guidelines are becoming mandatory: GIGW 3.0 for government, IS 17802 for everyone else, phased from 2026. What it means for the Northeast.
...
- **2016** — the RPwD Act. Section 40 requires the government to set accessibility standards; Sections 42 and 46 put duties on service providers and set a compliance timeline once standards exist.
- **2017–2023** — the RPwD Rules. Rule 15 listed accessibility guidelines but treated them as recommendatory. In 2023 the Rules adopted **IS 17802** (Part 1: 2021 requirements, Part 2: 2022 testing) as the ICT standard.
- **8 November 2024** — *Rajive Raturi v Union of India*. The Supreme Court held that recommendatory guidelines cannot satisfy a statutory duty, struck the recommendatory character of Rule 15, and gave the Union three months to frame mandatory rules with a floor of non-negotiable requirements.
- **16 July 2026** — draft RPwD (Amendment) Rules 2026 (S.O. 3962(E)), gazetted 20 July for a thirty-day comment period. The draft makes IS 17802 the mandatory floor for ICT products and services, phased by turnover, with fines under the Act, enhanced fines for failing to remedy within ninety days, and the possibility of a regulator suspending a registration or licence.
- **GIGW 3.0**, meanwhile, is already the standard every government website and app is audited against — 88 mandatory checkpoints covering accessibility, quality, security and lifecycle, verified by STQC before a site is certified.
...
- **Contrast** — 4.5:1 for text, 3:1 for large text and controls. Government blue on grey and most brand accents at small sizes fail.
- **Keyboard** — every action reachable and operable without a mouse, in order, with a visible focus indicator.
- **Names and labels** — every field labelled in the language of the page; every button and link saying what it does; every image described or marked decorative.
- **Structure** — headings in order, landmarks, one `h1`, tables with headers; the skeleton a screen reader navigates.
- **Forms and errors** — errors announced in text, explained, and correctable; time-outs extendable (OTP flows fail this constantly).
- **Language declared** — the page and every switch between languages marked up, so a screen reader changes voice; the failure that is invisible to sighted testers and universal on multilingual Indian sites.
- **Documents** — the PDFs government publishes tagged and readable, or provided as HTML.
- **Mobile** — reflow to 320px, touch targets large enough, orientation not locked; most citizens in the region meet the state on a phone.
...
*Sources: [Guidelines for Indian Government Websites and apps (GIGW 3.0)](https://guidelines.india.gov.in/introduction/) · [Supreme Court — Rajive Raturi v Union of India, 8 Nov 2024 (2024 INSC 858)](https://api.sci.gov.in/supremecourt/2005/9321/9321_2005_1_1503_56986_Judgement_08-Nov-2024.pdf) · [Draft RPwD (Amendment) Rules 2026 — IndiaLaw summary](https://www.indialaw.in/blog/regulatory/rpwd-amendment-rules-2026/) · [Mondaq — the new accessibility conformance regime](https://www.mondaq.com/india/compliance/1824050/the-new-accessibility-conformance-regime-key-takeaways-from-the-draft-rpwd-amendment-rules-2026) · [DigitalA11Y — India's digital accessibility laws](https://www.digitala11y.com/indias-digital-accessibility-laws-and-overview/) · [W3C — WCAG 2.1](https://www.w3.org/TR/WCAG21/)*

---

## Notes for sign-off

1. **The draft rules.** Everything about deadlines is from the July 2026 draft (comment period closed ~19 August); as of writing they have not been notified as final. The piece says "draft" and "once notified" throughout. If they've been finalised by the time you read this, tell me and it flips to the dates.
2. **IS 17802 ≈ WCAG 2.1 AA.** The standard is based on EN 301 549, which incorporates WCAG 2.1 AA; I've written "modelled on" and "aligns with" rather than claiming equivalence.
3. **Named systems.** I've named the Inner Line Permit systems (real, in four states) and kept state portals generic rather than naming Sewa Setu etc. — say if you'd like specific portals named for search.
4. **Languages.** The list is the official languages across the eight states; "one written in two scripts" refers to Manipuri (Bengali script and Meitei Mayek). Cut if you'd rather not go that deep.
5. **SEBI and DPDP** are mentioned in one sentence each as adjacent regimes; both are real and current. Hero image in the editor before publishing.
