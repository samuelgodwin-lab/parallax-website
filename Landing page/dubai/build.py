...
sectors = [
 ...
 ('S&mdash;02 · Hospitality &amp; tourism', 'Bookings that skip the <em>middleman.</em>',
  ...
  ['Direct booking engines', 'Guest apps', 'F&amp;B ordering', 'Property UI'], ('sector-hospitality-1600', 'A beachfront resort lobby in Dubai: pointed sandstone arches, a mashrabiya screen throwing patterned light, a guest in linen checking in at a travertine desk, the sea through the far arch.'), (1280, 1600)),
 ('S&mdash;03 · Fintech &amp; financial services', 'Onboarding people <em>finish.</em>',
  ...
  ['Onboarding &amp; KYC flows', 'Payments UI', 'Advisor dashboards'], ('sector-fintech-1600', 'A sunlit limestone arcade in Dubai&rsquo;s financial district: an Emirati advisor in a kandura and a client in a grey suit at a small marble table with a tablet, palms and people along the colonnade.'), (1600, 1600)),
...
tiles = [
 ('Systems', 'Bilingual design systems', 'One component library, two directions. Layouts mirror rather than flip, so the Arabic product is designed, not translated.', ('bi-systems-800', 'An Emirati designer in an abaya at a monitor at blue hour, the same app interface mirrored right-to-left and left-to-right as grey blocks on the screen, the lit towers of Dubai beyond the glass.'), (800, 600)),
 ...
 ('Audit', 'Accessibility audits (WCAG 2.1 AA)', 'Measured page by page against the TDRA policy and the Dubai Universal Design Code, every failure specified as a fix rather than a finding.', ('bi-audit-1200', 'An Emirati man in a kandura and a colleague in a hijab testing a web application on a laptop at a walnut desk, the deep-blue dusk and towers of Dubai through the glass wall.'), (1200, 1200)),
 ...
 ('Data', 'PDPL-ready data flows', 'Consent, records of processing and breach paths designed into the product before the executive regulations make them a fine.', ('bi-pdpl-800', 'An Emirati man, a woman in a hijab and a man in a suit over printed system diagrams under a brass pendant in a glass room high in a Dubai tower at blue hour, the lit coastline below.'), (800, 600)),
