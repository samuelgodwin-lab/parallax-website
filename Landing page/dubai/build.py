...
tiles = [
 ...
 ('Handover', 'Handover to the next vendor', 'Documentation, tokens and test evidence that let another team pick it up &mdash; a supplier requirement for most government and enterprise work.', ('bi-handover-800', 'A designer sliding a bound documentation binder and a laptop across a pale oak table to an Emirati woman in an abaya and her colleague, printed screens on the wall behind.'), (800, 600)),
]
