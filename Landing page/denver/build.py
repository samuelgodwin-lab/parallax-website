...
b = rep(b, 'main.js?v=1', 'main.js?v=3')   # bumped 17 Sep (setQuality pin) and 21 Sep (FAQ)
...
<meta property="og:image" content="https://www.parallaxorg.com/denver/images/og-denver.png">
...
<meta name="twitter:image" content="https://www.parallaxorg.com/denver/images/og-denver.png">
...
subprocess.run([sys.executable, f"{ROOT}/Landing page/seo.py", "denver"], check=True)
